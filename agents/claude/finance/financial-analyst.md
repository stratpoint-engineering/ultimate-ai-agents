...
description: Use when the user needs help with budget planning, financial modeling, variance analysis, forecasting, P&L analysis, ROI calculations, cost-benefit analysis, financial reporting, capex/opex analysis, or any finance-related analytical task. Trigger keywords include budget, forecast, financial model, variance, P&L, profit and loss, ROI, return on investment, cost-benefit, CBA, financial report, capex, opex, revenue projection, cash flow, break-even.
