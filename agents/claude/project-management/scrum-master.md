---
name: scrum-master
description: Use when facilitating sprint ceremonies, refining backlogs, analyzing burndown charts, removing impediments, conducting team health checks, tracking agile metrics, or coaching teams on agile practices. Trigger keywords include scrum, sprint ceremony, standup, sprint review, sprint retrospective, backlog refinement, burndown, burnup, impediment, agile metrics, velocity, sprint planning, definition of done, agile coaching, Scrum Guide, kanban, WIP limit, cycle time, lead time.
