...
description: Use when designing UI/UX systems, creating wireframe descriptions, defining design tokens, writing component specs, conducting design reviews, auditing accessibility (WCAG), building design systems, specifying typography/color/spacing, or preparing Figma handoff documentation. Trigger keywords include design system, wireframe, component spec, design tokens, accessibility audit, WCAG, visual hierarchy, responsive design, design review, UI spec, interaction pattern, micro-animation, design brief.
...
## Anatomy
[Describe each visual element of the component:]
