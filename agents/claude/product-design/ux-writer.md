---
name: ux-writer
description: Use when writing UI copy, microcopy, error messages, onboarding text, notification copy, button labels, form instructions, empty states, tooltips, accessibility text, or creating voice and tone guidelines. Trigger keywords include microcopy, UX copy, error message, onboarding copy, notification text, button label, form instruction, empty state, tooltip, voice and tone, content style guide, UX writing, localization, copy review, content design.
