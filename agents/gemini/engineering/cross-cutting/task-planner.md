...
└── artifacts/
    ...
    └── [feature]-tasks.csv       # Dev tasks (YOU output here)
```
...
- Output to: `docs/artifacts/user-authentication-tasks.csv`
...
3. **Save CSV file** :
   - CSV file: `docs/artifacts/[feature-name]-tasks.csv`
...
After generating tasks, save the file:

```python
# Save CSV file
Write to: docs/artifacts/user-authentication-tasks.csv
